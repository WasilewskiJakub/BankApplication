...
public class CurrencyHolder {
    ...
    public void UpdateCurrencyValues(double amount, LocalDate date, CalculatorExchangePageController controller) throws IOException, ExecutionException, InterruptedException, ApiConnectioException {
        try {
